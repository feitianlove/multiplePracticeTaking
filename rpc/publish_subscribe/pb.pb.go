...
var file_pb_proto_rawDesc = []byte{
	,
}
...
var file_pb_proto_goTypes = []interface{}{
	(*String)(nil), // 0: publish_subscribe.String
}
var file_pb_proto_depIdxs = []int32{
	0, // 0: publish_subscribe.PubsubService.Publish:input_type -> publish_subscribe.String
	0, // 1: publish_subscribe.PubsubService.Subscribe:input_type -> publish_subscribe.String
	0, // 2: publish_subscribe.PubsubService.Publish:output_type -> publish_subscribe.String
	0, // 3: publish_subscribe.PubsubService.Subscribe:output_type -> publish_subscribe.String
...
func (c *pubsubServiceClient) Publish(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/publish_subscribe.PubsubService/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubsubServiceClient) Subscribe(ctx context.Context, in *String, opts ...grpc.CallOption) (PubsubService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PubsubService_serviceDesc.Streams[0], "/publish_subscribe.PubsubService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func _PubsubService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publish_subscribe.PubsubService/Publish",
	}
...
var _PubsubService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "publish_subscribe.PubsubService",
