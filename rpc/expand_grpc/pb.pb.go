...
var file_pb_proto_rawDesc = []byte{
	0x0a, 0x08, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x65, 0x78, 0x70, 0x61,
	0x6e, 0x64, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x1a, 0x1c, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f,
	...
	,
...
var file_pb_proto_goTypes = []interface{}{
	(*StringMessage)(nil), // 0: expand_grpc.StringMessage
}
var file_pb_proto_depIdxs = []int32{
	0, // 0: expand_grpc.RestService.Get:input_type -> expand_grpc.StringMessage
	0, // 1: expand_grpc.RestService.Post:input_type -> expand_grpc.StringMessage
	0, // 2: expand_grpc.RestService.Get:output_type -> expand_grpc.StringMessage
	0, // 3: expand_grpc.RestService.Post:output_type -> expand_grpc.StringMessage
...
func (c *restServiceClient) Get(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/expand_grpc.RestService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *restServiceClient) Post(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	out := new(StringMessage)
	err := c.cc.Invoke(ctx, "/expand_grpc.RestService/Post", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RestService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/expand_grpc.RestService/Get",
	}
...
func _RestService_Post_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/expand_grpc.RestService/Post",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _RestService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "expand_grpc.RestService",
...
/*
 ...
 protoc -I/usr/local/include -I. \
    -I$GOPATH/src \
    -I/Users/ftfeng/GOPATH/pkg/mod/github.com/grpc-ecosystem/grpc-gateway@v1.16.0/third_party/googleapis \
    --grpc-gateway_out=. --go_out=plugins=grpc:. pb.proto
